...
public class HttpUtil {
     ...
     * @param url
     * @param params
     * @return com.source.util.HttpUtil.ResEntity
     * @author Source
     * @date 2020-03-15
     */
    ...
    public static ResEntity doGet(String url, Map<String, Object> headers, Map<String, Object> cookies, Map<String, Object> params) throws IOException {
        ...
        try {
            ...
            if (statusCode == HttpStatus.OK.value() || statusCode == HttpStatus.FOUND.value()) {
                ...
                if (resultEntity != null) {
                    ...
                    resEntity.setLocation(location);
     ...
     * @date 2020/2/4
     */
    public static ResEntity doPosts(String url, Map<String, Object> headers, String cookies, Map<String, Object> params) throws IOException {
     ...
     * @date 2020/2/4
     */
    public static ResEntity getLocation(String url, Map<String, Object> headers, Map<String, Object> cookies, Map<String, Object> params) throws IOException {
        HttpPost httpPost = new HttpPost(baseUrl + url);
        // 拼接参数
        if (params != null && !params.isEmpty()) {
            List<NameValuePair> pairs = new ArrayList<>(params.size());
     ...
     * @date 2022/10/09
     */
    public static String getLocation(CloseableHttpResponse response) {
    ...
    public static InputStream doDownloadAvatar(String qq) {
        try {
            String avatar = "https://q1.qlogo.cn/g?b=qq&nk=" + qq + "&s=4";
            ResEntity resEntity = doDownload(avatar, null, null, null);
